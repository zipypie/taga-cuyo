...
import 'package:taga_cuyo/src/features/utils/dev_info.dart'; // Import AuthService
...
class SupportTicketService {
  ...
  Future<void> submitTicket(
      String name, String email, String issue, File? image) async {
    ...
    if (userId == null) {
      throw Exception(
          'User is not authenticated'); // Handle this case appropriately
    }
    ...
    Map<String, dynamic> ticketData = {
      ...
      'osVersion': deviceInfo['osVersion'] ?? 'Unknown OS',
    };
